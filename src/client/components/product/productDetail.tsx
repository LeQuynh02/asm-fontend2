              ...
              <div className="w-[460px]">
                ...
                <div className="flex">
                  ...
                  <div className="mx-3 border h-[40px] w-[120px] flex justify-around">
                    <input type="number" id="inputValue" defaultValue={1} className="w-10 text-center mx-2 quantity" />
                  </div>
                </div>
                <div className="mt-7">
                  <button className="bg-red-500 h-10 w-44 rounded-sm text-white" onClick={()=>{
                    ...
                    <i className="fa-solid fa-cart-plus"></i><Link to= "../Cart" className='text-white'> Thêm sản phẩm </Link>
                  </button>
                </div>
